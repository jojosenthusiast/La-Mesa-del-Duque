...
- Agrega ~280 líneas de CSS operacional a `marca.css`: shell, page headers, status badges (5 variantes semánticas), acciones (primary/success/danger/neutral), tabla operativa con tabular numerals, toast zone y accessibility helpers.
