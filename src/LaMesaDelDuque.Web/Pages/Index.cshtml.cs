...
public sealed record ModuleLinkVm(string Label, string Page, string Description, bool SoloOcupadas = false);
...
public class IndexModel : PageModel
{
    ...
    public void OnGet()
    {
        ...
        // Mesas ocupadas: acceso directo para revisar tabs activos/listos
        if (esEncargado || esCajero || esMesero)
            modulos.Add(new("Mesas ocupadas", "/Operaciones/Mesero/Index", "Ver y continuar pedidos únicamente en mesas ocupadas.", true));
