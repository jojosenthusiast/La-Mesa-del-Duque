...
namespace LaMesaDelDuque.Infraestructura.Migrations
{
    ...
    [Migration("20260530051405_AgregarDatosEntregaPedido")]
            ...
            modelBuilder.Entity("LaMesaDelDuque.Dominio.Entidades.Pedido", b =>
                {
                    ...
                    b.Property<string>("NombreClienteEntrega")
                        .HasMaxLength(120)
                    ...
                    b.ToTable("Pedido", t =>
                        {
                            t.HasCheckConstraint("CK_Pedido_Domicilio_DatosEntrega", "\"TipoServicio\" <> 'Domicilio' OR (\"MesaId\" IS NULL AND \"NombreClienteEntrega\" IS NOT NULL AND length(trim(\"NombreClienteEntrega\")) > 0 AND \"TelefonoEntrega\" IS NOT NULL AND length(trim(\"TelefonoEntrega\")) > 0 AND \"DireccionEntrega\" IS NOT NULL AND length(trim(\"DireccionEntrega\")) > 0)");
                        });
                });
