...
public class Pedido
{
    ...
    {
        if (Estado == EstadoPedido.EnCobro)
            return;
    ...
    public void MarcarListo()
    {
        ...
        if (Estado != EstadoPedido.EnPreparacion && Estado != EstadoPedido.EnCobro && Estado != EstadoPedido.Pagado)
            throw new ReglaDominioException("Solo un pedido en preparación, en cobro o pagado puede ser marcado como listo.");
